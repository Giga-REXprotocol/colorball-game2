...
const DEADLINE = 700; // ゲームオーバーになる高さ
...
class BubbeGame {
  ...
  showReadyMessage() {
    ...
    p.textContent = "カラーボールゲーム2";
    const p2 = document.createElement("p");
    p2.classList.add("subText");
    p2.textContent = "ボールを大きくしよう！";
...
encodeURIComponent('カラーボールゲーム') +
'&ref_src=twsrc%5Etfw';

anchor.setAttribute('href', hrefValue);
anchor.setAttribute('class', 'twitter-hashtag-button');
anchor.setAttribute('data-text', result);
anchor.innerText = 'Tweet #カラーボールゲーム自分のスコア';
